...
#new vnet
New-AzVirtualNetwork -name $vn1 -Location $loc -ResourceGroupName $rg -AddressPrefix "10.10.0.0/16"
New-AzVirtualNetwork -name $vn2 -Location $loc -ResourceGroupName $rg -AddressPrefix "10.11.0.0/16"
New-AzVirtualNetwork -name $vn3 -Location $loc -ResourceGroupName $rg -AddressPrefix "10.12.0.0/16"
