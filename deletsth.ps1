...
$VaultName = "gz-recoveryservicevault" #fetch automatically
$Subscription = "Visual Studio Enterprise Subscription - Gary Zhou" #fetch automatically
$ResourceGroup = "GaryZhou-Grp" #fetch automatically
$SubscriptionId = "c3724b76-2fd7-4a71-9d38-9a9eca25021d" #fetch automatically
